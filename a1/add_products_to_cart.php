...
error_reporting(E_ALL);
	...
	include_once(ABSOLUTE_PATH . '/classes/fruit_product.class.php'); //added fruit product class
	session_start();
?>
...
//moved includes to top of code	
	...
	$aryProductArray = unserialize($_SESSION['aryProductArray']); //changed $aryProductsArray to $aryProductArray
